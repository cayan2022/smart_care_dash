  ...
  <div>
    <form class="w-full add-role" @submit.prevent="handleSubmit">
      <div class="container">
        ...
        >
          <page-heading
            title="انشاء عرض  جديدة"
            desc="قم بتعبئة البيانات الآتية لانشاء عرض  جديدة"
          />
...
export default {
  ...
  methods: {
    ...
    async handleSubmit() {
      try {
        this.loading = true;
        await this.$axios.$post(`dashboard/pages/offers`, this.generateData());
