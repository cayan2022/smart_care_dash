  ...
  <div>
    <form class="w-full add-role" @submit.prevent="handleSubmit">
      <div class="container">
        ...
        >
          <page-heading
            title="انشاء فرد جديد"
            desc="قم بتعبئة البيانات الآتية لانشاء فرد جديد"
          />
...
export default {
  ...
  methods: {
    ...
    async handleSubmit() {
      try {
        this.loading = true;
        await this.$axios.$post(`dashboard/pages/doctors`, this.generateData());
